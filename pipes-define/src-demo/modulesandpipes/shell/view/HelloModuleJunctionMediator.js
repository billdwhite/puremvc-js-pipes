        ...
        var HelloModuleJunctionMediator = declare(org.puremvc.js.multicore.utilities.pipes.plumbing.JunctionMediator, {
            ...
            onRegister: function() {
                ...
                this.getJunction().registerPipe(PipeNames.STDIN,
                    org.puremvc.js.multicore.utilities.pipes.plumbing.Junction.OUTPUT,
                    new org.puremvc.js.multicore.utilities.pipes.plumbing.TeeSplit());
                // The HELLO_OUT_TO_HELLO pipe to the shell from all modules
                this.getJunction().registerPipe(PipeNames.HELLO_OUT_TO_HELLO,
                    org.puremvc.js.multicore.utilities.pipes.plumbing.Junction.INPUT,
                    new org.puremvc.js.multicore.utilities.pipes.plumbing.TeeMerge());
            ...
            handleNotification: function(notification) {
                ...
                switch (notification.getName()) {
                    case ShellFacadeConstants.CONNECT_HELLO_MODULE_TO_HELLO_MODULE:
                        ...
                        // Create the pipe
                        var moduleToShellJunction = new org.puremvc.js.multicore.utilities.pipes.plumbing.Pipe();
                        ...
                        // Create the pipe
                        var shellToModuleJunction = new org.puremvc.js.multicore.utilities.pipes.plumbing.Pipe();
