define(
    ...
    function(declare) {
        ...
        var HelloModuleColorFilterMessage = declare(puremvc.pipes.FilterControlMessage, {
            /**
        ...
        HelloModuleColorFilterMessage.BASE = puremvc.pipes.FilterControlMessage.BASE + '/HelloModule/';
