define(
    ...
    function(declare, HelloMessage, PipeNames, SetupInfoMessage, ShellFacade, ShellFacadeConstants) {
        ...
        var ShellJunctionMediator = declare(puremvc.pipes.JunctionMediator, {
            ...
            onRegister: function() {
                ...
                this.getJunction().registerPipe(PipeNames.STDOUT, puremvc.pipes.Junction.OUTPUT, new puremvc.pipes.TeeSplit());
                // The STDIN pipe to the shell from all modules
                this.getJunction().registerPipe(PipeNames.STDIN, puremvc.pipes.Junction.INPUT, new puremvc.pipes.TeeMerge());
            ...
            handleNotification: function(notification) {
                ...
                switch (notification.getName()) {
                    ...
                    case ShellFacadeConstants.CONNECT_MODULE_TO_SHELL:
                        ...
                        // Create the pipe
                        var moduleToShell = new puremvc.pipes.Pipe();
                        ...
                        // Create the pipe
                        var shellToModule = new puremvc.pipes.Pipe();
