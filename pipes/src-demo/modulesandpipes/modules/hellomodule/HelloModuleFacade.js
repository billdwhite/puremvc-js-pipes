define(
    ...
    function(declare, SendMessageToHelloModuleCommand, SendMessageToShellCommand,
        ...
        var HelloModuleFacade = declare([puremvc.Facade, puremvc.pipes.PipeAware], {
            ...
            acceptInputPipe: function(/*String*/name, /*PipeFitting*/pipe) {
                this.sendNotification(puremvc.pipes.JunctionMediator.ACCEPT_INPUT_PIPE, pipe, name);
            },
            ...
            acceptOutputPipe: function(/*String*/name, /*PipeFitting*/pipe) {
                this.sendNotification(puremvc.pipes.JunctionMediator.ACCEPT_OUTPUT_PIPE, pipe, name);
            }
        });
