    ...
    function(declare, HelloMessage, HelloModuleColorFilterMessage, PipeNames, HelloModuleConstants, HelloModuleMediator) {
        ...
        var HelloModuleJunctionMediator = declare(puremvc.pipes.JunctionMediator, {
            ...
            onRegister: function() {
                 ...
                 */
                var filter = new puremvc.pipes.Filter({name:HelloModuleColorFilterMessage.COLOR_FILTER_NAME});
                filter.setFilter(HelloModuleColorFilterMessage.filterMessageByColor);
                filter.setParams({color: color});
                filter.connect(new puremvc.pipes.PipeListener({context:this, listener:this.handlePipeMessage}));

                var teeMerge = new puremvc.pipes.TeeMerge();
                teeMerge.connect(filter);
                this.getJunction().registerPipe(PipeNames.STDIN, puremvc.pipes.Junction.INPUT, teeMerge);

                var teeSplit = new puremvc.pipes.TeeSplit();
                this.getJunction().registerPipe(PipeNames.HELLO_OUT_TO_HELLO, puremvc.pipes.Junction.OUTPUT, teeSplit);
            },
            ...
            handleNotification: function(notification) {
                ...
                switch (notification.getName()) {
                     ...
                     * pipe.
                     */
                    case puremvc.pipes.JunctionMediator.ACCEPT_INPUT_PIPE:
                        /*
                     ...
                     */
                    case puremvc.pipes.JunctionMediator.ACCEPT_OUTPUT_PIPE:
                        /*
